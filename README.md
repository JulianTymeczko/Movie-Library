...
As of today, our application definitely needs MAJOR improvements especially with the backend and frontend code. Not only were we missing one group member but we are still learning how to properly connect frontend code with backend code. The updated application would use a design update, make it more pleasant for users and definetely work on expanding our database so the movie search can be even greater than just Stephen King movies.


## Screenshots: 

![public/images/DATABASE.png](public/images/DATABASE.png)
